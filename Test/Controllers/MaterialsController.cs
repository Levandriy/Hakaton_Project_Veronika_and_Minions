    ...
    public class MaterialsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Materials != null ? 
                          ...
                          Problem("Entity set 'TestContext.Materials'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,File,Is_Public")] Materials materials)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,File,Is_Public")] Materials materials)
        {
            if (id != materials.Id)
            {
                return NotFound();
