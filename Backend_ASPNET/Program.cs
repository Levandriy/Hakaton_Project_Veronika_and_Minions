...
//Машина смерти, которая вроде чё-то обрабатывает и даже выводит данные.
//Цель - сделать так, чтобы данные были, проверять их будем с помощью простого вывода.
//Весь фронт на Илье, следовательно оформлять тут фронт никак не надо
...
app.Run();
//рекорт - заменить на класс из моделей
public record Person(string Name, int Age);
//json converter - мучать Илью
